        ...
        { // overhead-tank empty condition
            ...
            { // conditions when not to run upper motor
                ...
                { // conditions when not to run upper motor
                    LoadOff(overhead);
                    OClearScreen();
                    lcd.print("Motor can't run");
                    delay(delaynumber);
                    OClearScreen();
                    lcd.print("Lower tank low");
...
void OClearScreen()
{
    ...
    lcd.print("                   "); // gives effect of clear upper lcd row
    lcd.setCursor( 0 , 0);
}
...
void GClearScreen()
{
    ...
    lcd.print("                     "); // gives effect of clear lower lcd row
    lcd.setCursor(0,1);
}
